...
const tr = {
  ...
  why: {
    ...
    title: "Kurumsal üründe güven, güzel bir arayüzden daha fazlasıdır.",
    intro: "Kullanıcı deneyimini, veri güvenliğini, servis mimarisini ve yayın sonrası sürdürülebilirliği aynı masada çözeriz.",
    items: [
      { title: "Tek ekip, tek mimari", text: "Backend, mobil uygulama, web panel ve entegrasyonları aynı teknik plan içinde geliştiririz." },
      { title: "Güvenlik baştan düşünülür", text: "JWT, RBAC, 2FA, audit log, rate limiting ve yedekleme kararlarını proje başında netleştiririz." },
      { title: "Yol haritası görünürdür", text: "Keşif, prototip, geliştirme ve yayın aşamalarında kapsamı, riski ve çıktıyı açık tutarız." },
      { title: "Üretim sonrası destek", text: "Yayın sonrası performans, güvenlik ve yeni modül ihtiyaçlarını sürdürülebilir şekilde yönetiriz." },
    ],
  },
...
const en = {
  ...
  why: { eyebrow: "Why BayesSoft", title: "Trust in enterprise products goes beyond a polished interface.", intro: "We solve user experience, data security, service architecture and long-term maintainability together.", items: [
    { title: "One team, one architecture", text: "Backend, mobile, web dashboards and integrations follow one technical plan." },
    { title: "Security from day one", text: "JWT, RBAC, 2FA, audit logs, rate limits and backups are decided early." },
    { title: "A visible roadmap", text: "Scope, risk and outcomes stay clear from discovery through production." },
    { title: "Support after launch", text: "We sustainably manage performance, security and new modules after release." },
  ] },
...
const de = {
  ...
  why: { eyebrow: "Warum BayesSoft", title: "Vertrauen in Unternehmensprodukte ist mehr als eine schöne Oberfläche.", intro: "Wir lösen Nutzererlebnis, Datensicherheit, Servicearchitektur und langfristige Wartbarkeit gemeinsam.", items: [
    { title: "Ein Team, eine Architektur", text: "Backend, Mobile, Web-Dashboards und Integrationen folgen einem technischen Plan." },
    { title: "Sicherheit von Anfang an", text: "JWT, RBAC, 2FA, Audit-Logs, Rate Limits und Backups werden früh festgelegt." },
    { title: "Ein sichtbarer Fahrplan", text: "Umfang, Risiken und Ergebnisse bleiben von der Analyse bis zum Go-live transparent." },
    { title: "Support nach dem Start", text: "Performance, Sicherheit und neue Module betreuen wir nachhaltig nach dem Release." },
  ] },
